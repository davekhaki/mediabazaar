...
namespace MediaBazaarOOD_1.Class
{
    public class Admin:Person
    {
        ...
        //public Admin(int id, string givenFirstName, string givenLastName, int givenAge, string givenGender, string givenDname, DateTime givenHireDate, DateTime givenENdDate, int givenSalary, string givenAddress, string givenRole) : base(givenFirstName, givenLastName, givenAge, givenGender, givenDname, givenHireDate, givenENdDate, givenSalary, givenAddress, givenRole)
        //{
        //    base.Id++;
        //}
