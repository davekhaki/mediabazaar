...
namespace Group_2_project
{
    public partial class Employeeselfservice : Form
    {
        ...
        public void GetSchedule(string username) {
            ...
            MySqlCommand query = new MySqlCommand($"SELECT e.FirstName, e.LastName, s.EmployeeID, s.TimeOfDay, s.Day FROM (employee e INNER JOIN schedule s ON e.ID = s.EmployeeID) WHERE e.Username = '{username}' ;", conn);
