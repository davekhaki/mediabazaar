...
$sql="SELECT TimeOfDay,DATE_FORMAT(Day, '%d-%b-%y') AS Day FROM schedule WHERE EmployeeID=:empId GROUP BY Day,TimeOfDay ORDER BY Day DESC, CASE WHEN TimeOfDay='Morning' THEN '1' WHEN TimeOfDay='Afternoon' THEN '2'WHEN TimeOfDay='Evening' THEN '3'  END ";
