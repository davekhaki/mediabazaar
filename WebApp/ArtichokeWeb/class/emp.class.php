...
$sql="SELECT TimeOfDay,DATE_FORMAT(Day, '%d-%b-%y') AS Day FROM schedule WHERE EmployeeID=:empId GROUP BY Day ORDER BY CASE WHEN TimeOfDay='Morning' THEN '1' WHEN TimeOfDay='Afternoon' THEN '2' END ";
